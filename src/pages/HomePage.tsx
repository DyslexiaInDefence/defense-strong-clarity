    ...
    <>
      ...
      <section className="relative overflow-hidden py-20 md:py-32" aria-label="Hero">
        ...
        <div className="container mx-auto px-4 text-center">
          <img alt="Dyslexia in Defence shield logo" className="mx-auto mb-8 h-40 w-auto sm:h-48 md:h-56 lg:h-64 drop-shadow-lg object-fill" <img alt="Dyslexia in Defence shield logo" className="mx-auto mb-8 h-40 w-auto sm:h-48 md:h-56 lg:h-64 drop-shadow-lg object-fill" src="/lovable-uploads/4eee789e-61aa-4a04-8ec1-96380d579791.webp" /> />
